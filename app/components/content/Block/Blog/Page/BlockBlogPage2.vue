<template>
  <UiContainer class="py-16 lg:py-24">
    <div class="text-center">
      ...
      <h1 class="mb-4 text-4xl font-semibold lg:mb-6 lg:text-5xl">
    ...
    <div
      ...
      class="mt-10 hidden h-60 w-full items-end overflow-hidden bg-[url('https://images.unsplash.com/photo-1511447333015-45b65e60f6d5?q=80&w=2155&auto=format&fit=crop&ixlib=rb-4.0.3&ixid=M3wxMjA3fDB8MHxwaG90by1wYWdlfHx8fGVufDB8fHx8fA%3D%3D')] bg-cover drop-shadow lg:mt-24 lg:flex lg:h-[720px]"
    >
    ...
    <div class="mt-16 mb-10 lg:hidden">
      <NuxtLink :to="link">
        ...
        <img
          ...
          :alt="alt"
          class="mb-5 h-[240px] w-full object-cover"
        />
      </NuxtLink>
      <UiBadge
    ...
    <section class="mt-12 grid grid-cols-1 gap-y-12 lg:mt-16 lg:grid-cols-12 lg:gap-x-8">
      <div class="col-span-full bg-background lg:col-span-4">
        <div class="sticky top-5">
          ...
          <ul class="mt-5 flex flex-col gap-5 pl-2 font-medium md:text-sm">
            <template v-for="c in categories" :key="c">
              <li>
                <NuxtLink class="hover:text-primary" to="#">{{ c }}</NuxtLink>
              </li>
            </template>
          </ul>
        </div>
