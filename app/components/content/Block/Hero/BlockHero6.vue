<template>
  <UiContainer
    class="relative flex flex-col gap-y-5 py-10 md:flex-row md:justify-between lg:h-[720px] lg:gap-10"
  >
    <div class="absolute bottom-5 hidden lg:right-[410px] lg:block xl:right-[550px]">
      <svg
