---
title: Select - Native
description: Display a dropdown list of options for users to choose from.
links:
  - title: MDN Reference
...
Click :SourceCodeLink{component="NativeSelect.vue"} to see the source code for this component on GitHub. Feel free to copy it and adjust it for your own use.
...
:DocsNativeSelectOrigin

#code

<!-- automd:file src="../../app/components/content/Docs/NativeSelect/DocsNativeSelectOrigin.vue" code lang="vue" -->

```vue [DocsNativeSelectOrigin.vue]
<template>
  <div class="@container">
