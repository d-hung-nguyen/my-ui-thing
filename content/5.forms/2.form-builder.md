---
title: Form Builder
description: Quickly create a form from an array of objects.
links:
  - title: Vee-Validate
    href: https://vee-validate.logaretm.com/v4/tutorials/dynamic-form-generator/
    icon: logos:vue
...
To get started, you need to setup Vee Validate in your Nuxt project. You can do so by following the instructions outline in the [Forms Introduction](/forms) page.
...
<!-- automd:file src="../../app/components/content/Docs/FormBuilder/DocsFormBuilderFull.vue" code lang="vue" -->

```vue [DocsFormBuilderFull.vue]
<template>
  <form @submit="submit">
