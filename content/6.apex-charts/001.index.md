---
title: ApexCharts
description: A modern charting library that helps developers to create beautiful and interactive visualizations for web pages
links:
  - title: ApexCharts Docs
...
<!-- automd:file src="../../app/components/Ui/Apexchart.client.vue" code lang="vue" -->

```vue [Apexchart.client.vue]
<template>
