...
:MagicDocsAnimatedList

#code

<!-- automd:file src="../../../app/components/content/Magic/AnimatedList/MagicDocsAnimatedList.vue" code lang="vue" -->

```vue [MagicDocsAnimatedList.vue]
<template>
...
Click :SourceCodeLink{component="AnimatedList" folder="Magic" collection="magic"} to see the source code for this component on GitHub.
